...
namespace edhandho
{
    public class Result
    {
        ...
        public string? ErrorMessage => Message + ((ResultException != null && !string.IsNullOrEmpty(ResultException!.StackTrace)) ? ("; Error " + ResultException!.Message + "; StackTrace: " + ResultException!.StackTrace) : "");
